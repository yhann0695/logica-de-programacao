	...
	public static void main(String[] args) {
		...
		while(!ganhou) {
			...
			if(jogoVelha[linha][coluna] == 'X' || jogoVelha[linha][coluna] == 'O') {
				System.out.println("Essa posição já foi usada!");
			...
			if ((jogoVelha[0][0] == 'X' && jogoVelha[0][1] == 'X' && jogoVelha[0][2] == 'X') ||  //linha 1
					...
					(jogoVelha[0][0] == 'X' && jogoVelha[0][0] == 'X' && jogoVelha[2][0] == 'X') || //coluna 1
				...
				System.out.println("Parabéns, jogador 1 ganhou!");
					...
					(jogoVelha[0][0] == 'O' && jogoVelha[0][0] == 'O' && jogoVelha[2][0] == 'O') || //coluna 1
				...
				ganhou = true;
				System.out.println("Tudo empatado, ninguém ganhou!");
			}
